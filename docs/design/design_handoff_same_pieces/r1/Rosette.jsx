...
// In R1 (Same-Pieces) all three stars are earned for a clean, direct count of the
// same-size pieces; fewer stars are reserved for help-assisted or slow solves.
const Rosette = ({ count = 0, total = 3, size = 30 }) => {
