# Verdict cards (synthetic-learner red-team)
...
- **latent truth**: start 0.4665 → final 0.7861 (max 0.7861, below τ=0.8: true)
- **engine decisions**: PresentProblem ×4 → FadeScaffold → PresentProblem ×3 → FadeScaffold ×3 → PresentProblem ×12 → RaiseScaffold → PresentProblem ×4 → RaiseScaffold → PresentProblem ×2 → FadeScaffold ×2 → PresentProblem ×7
- **scope**: engine path only

## 2. False mastery — misconception-stable on ADD_UNLIKE_COPRIME
...
## 3. False mastery — misconception-stable on ADD_UNLIKE_NESTED
...
## 4. False mastery — misconception-stable on COMPARE_BENCHMARK
...
## 5. False mastery — misconception-stable on FRACTION_ON_LINE
...
## 6. False mastery — misconception-stable on MULT_EQUAL_GROUPS
...
## 7. False mastery — misconception-stable on MULT_FACTS
...
## 8. False mastery — misconception-stable on SIMPLIFY
...
## 9. False mastery — misconception-stable on SUB_SAME_DEN
...
## 10. False mastery — anxious-low-energy on ADD_SAME_DEN
...
- **latent truth**: start 0.35 → final 0.8775 (max 0.8775, below τ=0.8: false)
- **engine decisions**: PresentProblem ×21 → FadeScaffold ×2 → PresentProblem ×3 → FadeScaffold ×2 → PresentProblem ×12
- **scope**: engine path only

## 11. False mastery — anxious-low-energy on ADD_UNLIKE_COPRIME
...
## 12. False mastery — anxious-low-energy on ADD_UNLIKE_NESTED
...
## 13. False mastery — anxious-low-energy on COMPARE_BENCHMARK
...
## 14. False mastery — anxious-low-energy on FRACTION_ON_LINE
...
## 15. False mastery — anxious-low-energy on MULT_EQUAL_GROUPS
...
## 16. False mastery — anxious-low-energy on MULT_FACTS
...
## 17. False mastery — anxious-low-energy on SIMPLIFY
...
## 18. False mastery — anxious-low-energy on SUB_SAME_DEN
...
## 19. False mastery — bimodal on ADD_SAME_DEN
...
- **latent truth**: start 0.5 → final 0.5 (max 0.5, below τ=0.8: true)
- **engine decisions**: PresentProblem ×3 → FadeScaffold ×3 → PresentProblem → RaiseScaffold → PresentProblem ×3 → RaiseScaffold → PresentProblem ×2 → FadeScaffold ×2 → PresentProblem → RaiseScaffold ×2 → PresentProblem ×2 → FadeScaffold ×2 → PresentProblem → RaiseScaffold ×2 → PresentProblem ×2 → FadeScaffold ×2 → PresentProblem → RaiseScaffold → PresentProblem ×4 → FadeScaffold ×2 → PresentProblem ×2
- **scope**: engine path only

## 20. False mastery — bimodal on ADD_UNLIKE_COPRIME
...
## 21. False mastery — bimodal on ADD_UNLIKE_NESTED
...
## 22. False mastery — bimodal on COMPARE_BENCHMARK
...
## 23. False mastery — bimodal on FRACTION_ON_LINE
...
## 24. False mastery — bimodal on MULT_EQUAL_GROUPS
...
## 25. False mastery — bimodal on MULT_FACTS
...
## 26. False mastery — bimodal on SIMPLIFY
...
## 27. False mastery — bimodal on SUB_SAME_DEN
...
## 28. False mastery — fam-train-a on ADD_SAME_DEN
...
- **latent truth**: start 0.5639 → final 0.9028 (max 0.9028, below τ=0.8: false)
...
## 29. False mastery — fam-train-a on ADD_UNLIKE_COPRIME
...
## 30. False mastery — fam-train-a on ADD_UNLIKE_NESTED
...
## 31. False mastery — fam-train-a on COMPARE_BENCHMARK
...
## 32. False mastery — fam-train-a on FRACTION_ON_LINE
...
## 33. False mastery — fam-train-a on MULT_EQUAL_GROUPS
...
## 34. False mastery — fam-train-a on MULT_FACTS
...
## 35. False mastery — fam-train-a on SIMPLIFY
...
## 36. False mastery — fam-train-a on SUB_SAME_DEN
...
- **latent truth**: start 0.3039 → final 0.9434 (max 0.9434, below τ=0.8: false)
...
- **latent truth**: start 0.4799 → final 0.9729 (max 0.9729, below τ=0.8: false)
...
- **latent truth**: start 0.7 → final 0.7 (max 0.7, below τ=0.8: true)
...
- **rank**: 1.7 (harm 2 × plausibility 0.85 × novelty 1)
- **metric fired**: falseEscalation
- **occurrences in cluster**: 1
- **replay**: seed 1 · run run-1:over-hinter:MULT_EQUAL_GROUPS · step 33
- **latent truth**: start 0.4 → final 0.9314 (max 0.9314, below τ=0.8: false)
...
- **latent truth**: start 0.25 → final 0.8471 (max 0.8471, below τ=0.8: false)
