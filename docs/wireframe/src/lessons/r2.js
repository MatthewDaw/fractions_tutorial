...
export default {
  ...
  tabs: [
    ...
    { n: "✎", name: "Show Work", sub: "write out how you'd solve it on a blank slate", href: "room-r2-sw-showwork.html" },
    { n: "5", name: "Words", sub: "a plain-language word problem; read it and solve", href: "room-r2-7-words.html" },
