/* kitchen-r4 — Babushka's Kitchen question for №8 Equivalent Fractions.
...
export default {
  ...
  recipe: `This recipe uses <b>Lesson 8 · Equivalent Fractions</b> — multiply (or divide) the top and bottom by the same number.`,
