/* room-r5-5-words — №9 Mixed Numbers · Words (lesson r5, #/r5).
   ...
   lives here. Word-problem layout folded onto the 4 zones (spec Step 3):
   story → rail, optional scratch surface → stage, mixed-number write row →
   answer, Cook + ribbon → tutor. Interactive markup is verbatim. */
export default {
  kind: "lesson",
  ...
  stageHTML: `
          <div class="wp-setup">
                ...
                <div class="wp-setup-row">
                  <div class="r5-scratch-surface bs-surface" style="position:relative; width:740px; max-width:100%; height:300px;">
  ...
  railHTML: `
          <div class="panel">
            <h3>Word Problem</h3>
            <div class="hint">Babushka is cutting a cake into <b>quarters</b>. The party needs <b>11 quarters</b> in all. How many <b>whole</b> cakes is that, and how many quarters left over? No blocks, no equation — read the recipe, work out the improper fraction it describes, then write it as a mixed number.</div>
          </div>`,

  answerHTML: `
          <div class="wp-answer">
                <span class="wp-answer-lead">Write the mixed number</span>
                <div class="wp-answer-row">
                  <div class="r5-write">
                    <div class="r5-write-whole">
                      <!-- Slate layout="row" — one whole-number cell (autofocus ✎) -->
  ...
  tutorHTML: `
          <div class="ltutor">
            ...
            <div class="ribbon">A recipe — read it, find the improper fraction, and write the mixed number.</div>
          </div>`,
};
