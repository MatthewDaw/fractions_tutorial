/* room-num-paint — №4 The Top Number · Stage 1 "Paint". The first thing the child
   does: cut a whole strip by clicking the right divide button (the bottom number),
   then paint as many pieces as the top number. "Paint 3/4" → cut into 4, paint 3.
   Snapshot: ÷4 chosen, strip in 4 pieces, three painted. */
...
export default {
  ...
  railHTML: `
    <div class="panel">
      ...
      <div class="hint">
        <b>Paint 3/4 of the strip red.</b> First, <b>cut the strip</b> — click the
        <b>÷4</b> button so the bottom number is <b>4</b> (four equal pieces). Then
        <b>paint 3</b> of those pieces red — the top number says how many. Tap pieces
        to fill them; <b>Reset</b> to start over.
      </div>
    </div>`,
  ...
  answerHTML: `
    <div class="lbar">
      <div class="lbar-eq">
        ...
        <span class="nl-ans-amt">— <b>3</b> pieces of <b>4</b></span>
      </div>
  ...
  tutorHTML: tutor("First cut the strip into four — the bottom number. Then paint three of the four pieces red. Three over four."),
};
