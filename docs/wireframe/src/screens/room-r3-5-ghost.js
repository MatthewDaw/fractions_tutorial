/* room-r3-5-ghost — №10 Scale One · Ghost (LessonUnlikeDen, #/r3).
...
export default {
  ...
  stageHTML: `
          <div class="canvas lu-canvas" id="r2canvas">
            ...
            <!-- the lingering, dimmed, non-interactive strips -->
            <div class="ghost-backdrop">
              <!-- strip A — 3/8 (eighths hue #d1495b) -->
              <div class="nbar" style="left:60px; top:156px; width:225px;">
                ...
                <div class="plank" style="width:225px;">
              ...
              <!-- strip B — 1/4 (fourths hue #0a9396) -->
              <div class="nbar" style="left:60px; top:68px; width:150px;">
                ...
                <div class="plank" style="width:150px;">
                  <div class="plank-body">
  ...
  railHTML: `
          <div class="panel">
            <h3>From Memory</h3>
            <div class="hint">The bars are behind, faded — just a reminder. Rename the one that doesn't fit into an equivalent fraction over the common bottom, then add like same-denominators.</div>
