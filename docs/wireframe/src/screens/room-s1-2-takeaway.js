/* room-s1-2-takeaway — №7 Taking Away · Take Away (AppSubtract, SUB_SAME_DEN, #/s1 stage 2).
...
export default {
  ...
  stageHTML: `
          <div class="canvas s1-canvas s1-canvas-takeaway" id="s1canvas">
            <div class="eqstate eqfloat locked"><span class="g"><svg width="16" height="16" viewBox="0 0 24 24" aria-hidden="true" style="display:block"><rect x="4" y="11" width="16" height="11" rx="2" fill="none" stroke="var(--ink)" stroke-width="2" /><path d="M8 11 V8 a4 4 0 0 1 8 0 V11" fill="none" stroke="var(--ink)" stroke-width="2" /><circle cx="12" cy="16" r="1.6" fill="var(--ink)" /></svg></span>bottom stays /8</div>

            <div class="s1-line-label">on the line — what's left</div>
            <!-- 5 slots: idx 0 piece, idx 1,2 taken (dashed slots), idx 3,4 pieces -->
            <div class="s1-takeline">
              <div class="s1-piece s1-piece-drag" style="width:70px; background:#d1495b; border-right:1.5px solid rgba(237,226,200,0.55); border-radius:6px;">
                <div class="s1-piece-hatch" style="background-image:repeating-linear-gradient(90deg, rgba(237,226,200,0.34) 0 1px, transparent 1px 6px)"></div>
                <span class="s1-piece-lab" style="color:#ede2c8">1/8</span>
                <div class="s1-grip"><i></i><i></i><i></i></div>
              </div>
              <div class="s1-piece is-slot" style="width:70px"></div>
              <div class="s1-piece is-slot" style="width:70px"></div>
              <div class="s1-piece s1-piece-drag" style="width:70px; background:#d1495b; border-right:1.5px solid rgba(237,226,200,0.55); border-radius:6px;">
                <div class="s1-piece-hatch" style="background-image:repeating-linear-gradient(90deg, rgba(237,226,200,0.34) 0 1px, transparent 1px 6px)"></div>
                <span class="s1-piece-lab" style="color:#ede2c8">1/8</span>
            ...
            <!-- the "used" tray with 2 pieces dragged off -->
            <div class="s1-tray has-pieces">
              <span class="s1-tray-label">used by Babushka — drag pieces here</span>
              <div class="s1-tray-row">
                <div class="s1-piece is-used" style="width:70px; background:#d1495b; border-right:1.5px solid rgba(237,226,200,0.55);">
                  <span class="s1-piece-lab" style="color:#ede2c8">1/8</span>
                </div>
                <div class="s1-piece is-used" style="width:70px; background:#d1495b; border-right:1.5px solid rgba(237,226,200,0.55);">
                  <span class="s1-piece-lab" style="color:#ede2c8">1/8</span>
            ...
            <div class="s1-count-cap">3 left on the line · 2 taken away</div>
          </div>`,

  railHTML: `
          <div class="panel">
            <h3>Take It Away</h3>
            <div class="hint">Drag <b>2</b> pieces down into the tray — that's what Babushka used. Count the pieces still on the line: that's the answer's <b>top</b>. The bottom stays 8.</div>
            <div class="lockcard">
              <div class="bignum">
                <span class="n"><span style="color:var(--red)">−</span></span>
                <span class="bar" style="background:#d1495b"></span>
                <span class="d-wrap"><span class="d">8</span><span class="lockmark"><svg width="12" height="12" viewBox="0 0 24 24" aria-hidden="true" style="display:block"><rect x="4" y="11" width="16" height="11" rx="2" fill="none" stroke="var(--ink)" stroke-width="2" /><path d="M8 11 V8 a4 4 0 0 1 8 0 V11" fill="none" stroke="var(--ink)" stroke-width="2" /><circle cx="12" cy="16" r="1.6" fill="var(--ink)" /></svg></span></span>
              </div>
              <div class="lockcard-note">take tops apart<br />keep the 8</div>
            </div>
          </div>`,
  ...
  answerHTML: `
          <div class="lbar">
            <div class="lbar-eq">
              <span class="s1-frac">5/8</span>
              <span class="s1-op">−</span>
              <span class="s1-frac">2/8</span>
              <span class="s1-op">=</span>
              <span class="s1-slate">
                <div class="slate slate-fraction" role="group" aria-label="write the top number">
                  ...
                  <div class="slate-slot is-locked">
                    <div class="slate-cell" aria-label="bottom: 8"><span class="slate-fixed">8</span></div>
                  </div>
                </div>
              </span>
            </div>
            <div class="lbar-cap">drag 2 pieces off, count what's left, write the top</div>
  ...
  tutorHTML: `
          <div class="ltutor">
            ...
            <div class="ribbon">You took 2 eighths away — count what's left, then write the top number. The bottom stays 8.</div>
          </div>`,
};
