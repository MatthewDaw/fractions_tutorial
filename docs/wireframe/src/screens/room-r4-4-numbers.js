/* room-r4-4-numbers — №9 Simplify · Numbers · Stage 4 (AppR4, #/r4).
...
export default {
  ...
  goalHTML: `Just the numbers: <b>8/12 = ?</b> Write the equivalent fraction in lowest terms — its simplest name. No bar to lean on.`,

  stageHTML: `
          <div class="canvas r4-s-canvas" id="r3canvas">
            <div class="r4-bare-eq">
              <div class="bignum"><span class="n">8</span><span class="bar" style="background:#386641;"></span><span class="d">12</span></div>
              <span class="r4-bigeq-op">=</span>
              <span class="r4-bigeq-q">?</span>
            </div>
          </div>`,
  ...
  railHTML: `
          <div class="panel">
            ...
            <div class="hint">No tools — just the numbers. Divide the top and bottom by their largest shared factor (dividing by 1), then write the equivalent fraction in lowest terms — its simplest name — on the Slate.</div>
            <div class="r4-card">
              <div class="bignum"><span class="n">8</span><span class="bar" style="background:#386641;"></span><span class="d">12</span></div>
              <div class="r4-card-note">write this in<br><b>lowest terms</b></div>
            </div>
          </div>`,
  ...
  tutorHTML: `
          <div class="ltutor">
            ...
            <div class="ribbon">"Just the numbers now: 8/12. Write the equivalent fraction in lowest terms — the same amount with the smallest numbers."</div>
          </div>`,
};
