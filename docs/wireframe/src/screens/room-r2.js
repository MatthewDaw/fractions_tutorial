/* room-r2 — №8 Cross-Multiply · Manipulate (LessonUnlikeDen, beat L0, #/r2).
...
export default {
  ...
  stageHTML: `
          <div class="canvas lu-canvas" id="r2canvas">
            ...
            <!-- ruler — 0 → 1, divided into the common /6 -->
            ...
            <!-- strip A · 1/2 re-cut to sixths (3/6, ×3) -->
            <div class="nbar" style="left:60px; top:156px; width:300px;">
              ...
              <div class="plank is-matched" style="width:300px;">
            ...
            <!-- strip B · 1/3 re-cut to the SAME sixths (2/6, ×2) -->
            <div class="nbar" style="left:60px; top:68px; width:200px;">
              ...
              <div class="plank is-matched" style="width:200px;">
                <div class="plank-body">
                  <div class="piece" style="width:100px; background:#caa300; border-right:1px solid rgba(20,14,10,.34);">
                    <div class="piece-hatch" style="background-image:repeating-linear-gradient(45deg, rgba(20,14,10,.34) 0 1px, transparent 1px 6px), repeating-linear-gradient(-45deg, rgba(20,14,10,.34) 0 1px, transparent 1px 6px);"></div>
                    <span class="piece-lab" style="color:#1c1612; font-size:15px;">1/6</span>
  ...
  railHTML: `
          <div class="panel">
            ...
            <div class="knife-rack" style="opacity:0.3; pointer-events:none;">
              <div class="knife-row">
                <svg width="111.36" height="40.32" viewBox="0 0 232 84" class="knife" style="display:block; touch-action:none; cursor:grab; overflow:visible;">
                  <defs>
