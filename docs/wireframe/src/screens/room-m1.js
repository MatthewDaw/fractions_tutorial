...
export default {
  ...
  stageHTML: `
          <div class="canvas m1-canvas">
            <div class="m1-board-head">Drag the <b>same 4</b> onto every plate</div>

            <div class="mg-fit mg-fit-pile">
              <!-- the draggable pile of pelmeni (12 left) -->
              <div class="mg-pile" role="group" aria-label="pile of pelmeni — 12 left, drag onto a plate">
                <div class="mg-pile-bowl">
                  <span class="mg-pile-piece" role="button" tabindex="0" aria-label="pelmeni — drag onto a plate" style="touch-action:none;">
                    <svg width="32" height="32" viewBox="0 0 26 26" aria-hidden="true" class="mg-pelmeni"><path d="M3 15 Q3 7 13 7 Q23 7 23 15 Q23 21 13 21 Q3 21 3 15 Z" fill="#c9a36b" stroke="#9a7740" stroke-width="1.6" /><path d="M5 13 Q13 9 21 13" fill="none" stroke="#9a7740" stroke-width="1.1" opacity="0.7" /></svg>
                  </span>
                  <span class="mg-pile-piece" role="button" tabindex="0" aria-label="pelmeni — drag onto a plate" style="touch-action:none;">
                    <svg width="32" height="32" viewBox="0 0 26 26" aria-hidden="true" class="mg-pelmeni"><path d="M3 15 Q3 7 13 7 Q23 7 23 15 Q23 21 13 21 Q3 21 3 15 Z" fill="#c9a36b" stroke="#9a7740" stroke-width="1.6" /><path d="M5 13 Q13 9 21 13" fill="none" stroke="#9a7740" stroke-width="1.1" opacity="0.7" /></svg>
                  </span>
                ...
                <div class="mg-pile-lab">🥟 12 left — drag onto a plate</div>
              </div>

              <!-- the vertical stack of 3 EMPTY plates -->
              <div class="mg-plates" role="group" aria-label="3 plates" style="--mg-plate:92px; --mg-piece:24px;">
                <div class="mg-group mg-plate is-normal">
                  <button type="button" class="mg-vessel is-normal" style="border-color:var(--ink-mute, #6b5a47); box-shadow:0 0 0 2px var(--ink-mute, #6b5a47)22;" title="drag pelmeni here — 0/4" aria-label="plate 1: 0 of 4 — drag a pelmeni here">
                    <span class="mg-vessel-pieces"></span>
                  </button>
                  <div class="mg-count" style="color:var(--ink-mute, #6b5a47);">0</div>
                </div>
                <div class="mg-group mg-plate is-normal">
                  <button type="button" class="mg-vessel is-normal" style="border-color:var(--ink-mute, #6b5a47); box-shadow:0 0 0 2px var(--ink-mute, #6b5a47)22;" title="drag pelmeni here — 0/4" aria-label="plate 2: 0 of 4 — drag a pelmeni here">
                    <span class="mg-vessel-pieces"></span>
                  </button>
                  <div class="mg-count" style="color:var(--ink-mute, #6b5a47);">0</div>
                </div>
                <div class="mg-group mg-plate is-normal">
                  <button type="button" class="mg-vessel is-normal" style="border-color:var(--ink-mute, #6b5a47); box-shadow:0 0 0 2px var(--ink-mute, #6b5a47)22;" title="drag pelmeni here — 0/4" aria-label="plate 3: 0 of 4 — drag a pelmeni here">
                    <span class="mg-vessel-pieces"></span>
                  </button>
                  <div class="mg-count" style="color:var(--ink-mute, #6b5a47);">0</div>
                </div>
