/* room-r1-7-words — lesson step of №3 (rendered by LessonScreen).
...
export default {
  ...
  stageHTML: `
              <!-- optional, ungraded scratch — never gates the answer -->
                <div class="wp-setup">
                  <span class="wp-setup-lead">Optional — show your work here</span>
                  <div class="wp-setup-row">
                    <div class="bs-surface r1-words-scratch">
                      <canvas class="bs-canvas" role="img" aria-label="blank space to show your work"></canvas>
                      <div class="bs-tools">
  ...
  answerHTML: `
          <div class="lbar">
            <!-- answer surface — ENABLED (optional scratch never gates it) -->
                <div class="wp-answer">
                  <span class="wp-answer-lead">Write how much in all</span>
  ...
  tutorHTML: `
          <div class="ltutor">
            ...
            <div class="ribbon">A story this time — read it, find the two fractions, and write how much in all.</div>
          </div>`,
};
