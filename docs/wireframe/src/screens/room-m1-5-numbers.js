/* room-m1-5-numbers — №1 Equal Groups · Numbers (Stage 5, #/m1).
...
export default {
  ...
  stageHTML: `
          <div class="canvas m1-canvas m1-canvas-center">
            <div class="m1-bigeq">
              <span class="m1-bigeq-term">3</span>
              <span class="m1-bigeq-op">×</span>
              <span class="m1-bigeq-term">4</span>
              <span class="m1-bigeq-op">=</span>
              <span class="m1-bigeq-q">?</span>
            </div>
            <div class="m1-numbers-cap">No plates now — 3 groups of 4. Add 4 three times, or multiply.</div>
          </div>`,

  railHTML: `
          <div class="panel">
            <h3>Write the Product</h3>
            <div class="hint">3 groups of 4. Skip-count 4, 8, 12, or multiply.</div>
  ...
  answerHTML: `
          <div class="lbar">
            <div class="lbar-eq">
              <span class="m1-fz-frac">3 × 4</span>
  ...
  tutorHTML: `
          <div class="ltutor">
            ...
            <div class="ribbon">Just the numbers: 3 × 4 = ? Write the product on the Slate.</div>
          </div>`,
};
