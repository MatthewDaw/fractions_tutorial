/* room-r3-7-words — №6 Scale One · Words. Word-problem page folded onto the
   shared <LessonScreen> 4-zone grid (spec Step 3). Story+hint → rail, the
   primary writing surface → stage, the final answer slate → answer, Cook →
   tutor. The duplicate text box (goal banner + wp-card chrome) is removed.
...
export default {
  ...
  stageHTML: `
          <div class="lu-words-scratch bs-surface" style="position:relative;width:100%;height:132px;">
            <canvas class="bs-canvas" aria-label="optional: show your work on the blank slate"></canvas>
            <div class="bs-tools">
  ...
  railHTML: `
          <div class="panel">
            ...
            <div class="hint">Babushka rolls out three eighths of the dough, then one fourth more. How much of the dough is rolled out now? Read the recipe, work out the two fractions yourself, and write the total.</div>
          </div>`,

  answerHTML: `
          <div class="wp-answer">
            <span class="wp-answer-lead">Write the total</span>
            <div class="wp-answer-row">
              <!-- answer Slate: child writes the total from scratch (no setup gate on Words) -->
            ...
            <button type="button" class="newprob lu-words-newrecipe">↻ New recipe</button>
          </div>`,
  ...
  tutorHTML: `
          <div class="ltutor">
            ...
            <div class="ribbon">A recipe! Read it, work out the two fractions yourself, and write the total.</div>
          </div>`,
};
