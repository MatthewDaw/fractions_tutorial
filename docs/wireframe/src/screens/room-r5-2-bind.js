/* room-r5-2-bind — №10 Mixed Numbers · Bind, Stage 2 (AppR5, #/r5).
...
export default {
          ...
          <div class="fit-stage r5-board-fit">
            <div class="fit-stage-content" style="transform: scale(1);">
              <div class="canvas r5-canvas" id="r5canvas">
                ...
                <!-- OVERFLOW COLUMN — all grouped (locked): just the tag + "all grouped" -->
                ...
                <!-- WHOLE-UNIT FRAME — filled with 7 pieces, LOCKED, "1 whole" stamp -->
                ...
                <!-- LEFTOVER TRAY — the 2 leftover sevenths (the fraction part) -->
  ...
  answerHTML: `
          <div class="lbar">
            ...
            <div class="lbar-cap">write the whole number and the leftover on top</div>
  ...
  tutorHTML: `
          <div class="ltutor">
            ...
            <div class="ribbon">"Snap! Seven make one whole, 2 left over. Now WRITE the mixed number on the Slate."</div>
          </div>`,
};
