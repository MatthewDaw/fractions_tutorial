...
export default {
  ...
  railHTML: `
          <div class="panel">
            <h3>Collapse to Times</h3>
            <div class="hint">4 + 4 + 4 is 3 groups of 4 — that's 3 × 4. Collapse it, then write the product.</div>
  ...
  answerHTML: `
          <div class="lbar">
            <div class="lbar-eq">
              <span class="m1-fz-frac">4 + 4 + 4</span>
  ...
  tutorHTML: `
          <div class="ltutor">
            ...
            <div class="ribbon">The plates just confirm it now — let the numbers lead. Collapse 4 + 4 + 4 into 3 × 4, then write the product.</div>
          </div>`,
};
