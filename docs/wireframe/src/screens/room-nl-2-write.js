...
export default {
  ...
  goalHTML: `The bar is built from <b>1/3</b> pieces. Count how many sit on the line from
          <b>0</b>, and <b>write</b> that fraction — the count on top, the part size (3)
          on the bottom.`,
  ...
  stageHTML: `
          <div class="canvas nl-blk-canvas" id="nlcanvas">
            <!-- number line: 0 → 1 whole, span 480px from ORIGIN 96, ticks every 1/3 -->
            ...
            <span class="ntick" style="left:256px;top:258px;height:9px"></span>
            <span class="ntick" style="left:416px;top:258px;height:9px"></span>
            <span class="ntick is-major" style="left:576px;top:258px;height:16px"></span>
            <span class="nlab ng" style="left:96px;top:272px">0</span>
            <span class="nlab nl-partlab" style="left:256px;top:272px">1/3</span>
            <span class="nlab nl-partlab" style="left:416px;top:272px">2/3</span>
            <span class="nlab ng" style="left:576px;top:272px">1</span>

            <!-- the marked point is a PLACED bar of two 1/3 pieces (0→2/3). The child
                 counts the pieces and writes the fraction. No total is shown. -->
            <div class="nbar" style="left:96px;top:186px;width:320px">
              <div class="plank lit" style="width:320px">
                <div class="plank-body">
                  <div class="piece" style="width:160px;background:#e07b00;border-right:1.5px solid rgba(237,226,200,0.55)">
                    ...
                    <span class="piece-lab" style="color:#ede2c8;font-size:15px">1/3</span>
                  ...
                  <div class="piece" style="width:160px;background:#e07b00;border-right:none">
                    <div class="piece-hatch" style="background-image:repeating-linear-gradient(45deg, rgba(237,226,200,0.34) 0 1px, transparent 1px 6px), repeating-linear-gradient(-45deg, rgba(237,226,200,0.34) 0 1px, transparent 1px 6px)"></div>
                    <span class="piece-lab" style="color:#ede2c8;font-size:15px">1/3</span>
                  </div>
                </div>
  ...
  railHTML: `
    <div class="panel">
            <h3 class="pick-title">A Fraction Is a Number</h3>
            <div class="hint">
              Each piece on the line is <b>1/3</b> — one of the three equal parts from
              <b>0</b> to <b>1</b>. Count the pieces; that count goes on <b>top</b>, the
              part size <b>3</b> on the bottom. Two pieces is <b>2/3</b>.
            </div>
          </div>`,
  ...
  answerHTML: `
    <div class="lbar">
            <div class="lbar-eq">
              <div class="nl-ans-eqrow">
                <span class="nl-ans-lead">the point is</span>
                <span class="nl-ans-slate">
                  <div class="slate slate-fraction" role="group" aria-label="write the fraction the point names">
            ...
            <div class="lbar-cap">write the fraction the point names, then Check</div>
  ...
  tutorHTML: `
    <div class="ltutor">
            ...
            <div class="ribbon">Count the 1/3 pieces sitting on the line from 0 — that's the top number; the part size 3 is the bottom. Write it on the Slate.</div>
          </div>`,
};
