/* room-r4-5-applied — №9 Simplify · Applied (word→math gate, 5/r4).
...
export default {
  ...
  railHTML: `
          <div class="panel">
            ...
            <div class="hint"><b>8/12</b> of the loaf is left — write the same amount with its simplest name. First write the fraction the words describe; once that's checked, write its simplest name.</div>
          </div>`,

  stageHTML: `
          <div class="r4-s-story">
            <!-- the word→math surface: REQUIRED setup gate (transcribe 8/12 first) -->
            <div class="r4-s-setup">
              <span class="r4-s-setup-lead">First, write the fraction the words describe</span>
              <div class="r4-s-setup-row">
                <!-- Slate, layout="fraction", den=12 — STYLUS write cells (uncommitted) -->
                <div class="slate slate-fraction" role="group" aria-label="write the fraction the words describe">
                  ...
                  <span class="slate-bar" style="background:#386641;" aria-hidden="true"></span>
                  <div class="slate-slot">
                    <div class="slate-cell">
  ...
  answerHTML: `
          <div class="lbar r4-s-answer-words">
            <div class="r4-s-ansprompt">Now write the same amount as its simplest name</div>
            <div class="r4-s-answrite">
              <!-- Slate, layout="fraction", den=3 — disabled (gate not yet cleared) -->
              <div class="slate slate-fraction is-disabled" role="group" aria-label="write the simplest fraction">
  ...
  tutorHTML: `
          <div class="ltutor">
            ...
            <div class="ribbon">A question in words. First write the fraction it describes — 8/12 — then its simplest name unlocks.</div>
          </div>`,
};
