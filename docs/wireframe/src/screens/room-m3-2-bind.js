/* room-m3-2-bind — №2 Times Facts · Bind (AppM3, #/m3).
...
export default {
  ...
  stageHTML: `
          <div class="fit-stage canvas m3-fz-canvas" id="m3canvas">
            <div class="fit-stage-content" style="transform:scale(0.62);">
              <div class="m3-bind">
                <div class="m3-bind-jar">
                    ...
                    <div class="m3-jar" aria-label="jar holding 7 groups of 8 — 56 cubes">
                      ...
                      <div class="m3-jar-body">
                        <div class="m3-jar-cubes">
                          <div class="m3-cluster" style="grid-template-columns:repeat(8,1fr);">${pebble()}${pebble()}${pebble()}${pebble()}${pebble()}${pebble()}${pebble()}${pebble()}</div>
                          <div class="m3-cluster" style="grid-template-columns:repeat(8,1fr);">${pebble()}${pebble()}${pebble()}${pebble()}${pebble()}${pebble()}${pebble()}${pebble()}</div>
                          <div class="m3-cluster" style="grid-template-columns:repeat(8,1fr);">${pebble()}${pebble()}${pebble()}${pebble()}${pebble()}${pebble()}${pebble()}${pebble()}</div>
                          <div class="m3-cluster" style="grid-template-columns:repeat(8,1fr);">${pebble()}${pebble()}${pebble()}${pebble()}${pebble()}${pebble()}${pebble()}${pebble()}</div>
                          <div class="m3-cluster" style="grid-template-columns:repeat(8,1fr);">${pebble()}${pebble()}${pebble()}${pebble()}${pebble()}${pebble()}${pebble()}${pebble()}</div>
                ...
                <div class="m3-ribbon" aria-label="skip-count ribbon">
                  <span class="m3-ribbon-lead"><b>rows</b> · count by 8s</span>
                  <span class="m3-ribbon-term" data-step="8"><span class="m3-ribbon-row" aria-label="1 row">1</span>8</span>
                  <span class="m3-ribbon-term" data-step="8"><span class="m3-ribbon-row" aria-label="2 rows">2</span>16</span>
                  <span class="m3-ribbon-term" data-step="8"><span class="m3-ribbon-row" aria-label="3 rows">3</span>24</span>
                  <span class="m3-ribbon-term" data-step="8"><span class="m3-ribbon-row" aria-label="4 rows">4</span>32</span>
                  <span class="m3-ribbon-term" data-step="8"><span class="m3-ribbon-row" aria-label="5 rows">5</span>40</span>
                  <span class="m3-ribbon-term" data-step="8"><span class="m3-ribbon-row" aria-label="6 rows">6</span>48</span>
                  <span class="m3-ribbon-term is-blank" data-step="8"><span class="m3-ribbon-row" aria-label="7 rows">7</span>?</span>
                </div>
              </div>
            </div>
          </div>`,
  ...
  railHTML: `
          <div class="panel">
            ...
            <div class="hint">The ribbon counts 8, 16, 24, 32, 40, 48… one more 8 lands on the answer. Write the final number on the Slate.</div>
            <div class="m3-factcard">
              <span class="m3-factcard-eq">7 × 8 = ?</span>
              <div class="m3-factcard-note">count by 8</div>
            </div>
          </div>`,
  ...
  answerHTML: `
          <div class="lbar">
            ...
            <div class="lbar-cap">write the final number on the Slate, then Check</div>
  ...
  tutorHTML: `
          <div class="ltutor">
            ...
            <div class="ribbon">The ribbon already counts 8, 16, 24, 32, 40, 48… — one more 8 lands on the answer. Write the product.</div>
          </div>`,
};
