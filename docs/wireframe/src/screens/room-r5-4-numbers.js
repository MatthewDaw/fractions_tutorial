/* room-r5-4-numbers — №10 Mixed Numbers · Numbers · Stage 4 (#/r5).
...
export default {
  ...
  stageHTML: `
          <div class="fit-stage r5-board-fit">
            <div class="fit-stage-content" style="transform: scale(1);">
              <div class="canvas r5-canvas r5-bare">
                <div class="r5-bare-eq">
                  <span class="r5-bare-frac">14/7</span>
                  <span class="qop">=</span>
                  <span class="slate-blank">?</span>
                </div>
                <div class="r5-bare-note">14 ÷ 7 — how many whole 7-piece units fit, and what's left over?</div>
              </div>
            </div>
          </div>`,
  ...
  railHTML: `
          <div class="panel">
            ...
            <div class="r5-card">
              ...
              <div class="r5-card-note">14 ÷ 7 = 2 remainder 0. The wholes are the whole number; the remainder over 7 is the leftover fraction.</div>
            </div>
          </div>`,
          ...
          <div class="lbar">
            <div class="lbar-eq">
              <div class="r5-ans-eqrow">
                <span class="r5-ans-frac">14/7</span>
            ...
            <div class="lbar-cap">write the whole number — it's exactly 2 wholes</div>
  ...
  tutorHTML: `
          <div class="ltutor">
            ...
            <div class="ribbon">"Just the numbers: 14/7 = ? Write the whole mixed number on the Slate. (Watch the leftover!)"</div>
          </div>`,
};
