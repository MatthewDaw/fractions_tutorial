/* room-s1-3-numbers — №5 Taking Away · Numbers · Stage 3 (AppSubtract, 3/s1).
...
export default {
  ...
  stageHTML: `
          <div class="canvas s1-canvas s1-canvas-center" id="s1canvas">
            <div class="s1-bigeq">
              <!-- BigFrac 7/8 -->
              <div class="bignum"><span class="n">7</span><span class="bar" style="background:#d1495b"></span><span class="d">8</span></div>
              <span class="s1-bigeq-op">−</span>
              <!-- BigFrac 3/8 -->
              <div class="bignum"><span class="n">3</span><span class="bar" style="background:#d1495b"></span><span class="d">8</span></div>
              <span class="s1-bigeq-op">=</span>
              <!-- answer BigFrac: ? locked -->
              <div class="bignum"><span class="n">?</span><span class="bar" style="background:#d1495b"></span><span class="d-wrap"><span class="d">8</span><span class="lockmark"><svg width="12" height="12" viewBox="0 0 24 24" aria-hidden="true" style="display:block"><rect x="4" y="11" width="16" height="11" rx="2" fill="none" stroke="var(--ink)" stroke-width="2" /><path d="M8 11 V8 a4 4 0 0 1 8 0 V11" fill="none" stroke="var(--ink)" stroke-width="2" /><circle cx="12" cy="16" r="1.6" fill="var(--ink)" /></svg></span></span></div>
            </div>
            <div class="s1-numbers-cap">No blocks now — subtract the tops, keep the bottom 8, and write the answer.</div>
          </div>`,

  railHTML: `
          <div class="panel">
            <h3>Subtract the Tops</h3>
            <div class="hint">Take the tops apart (7 − 3) and keep the bottom 8. Write the top number on the Slate.</div>
            <div class="lockcard">
              <div class="bignum">
  ...
  answerHTML: `
          <div class="lbar">
            <div class="lbar-eq">
              <span class="s1-frac">7/8</span>
              <span class="s1-op">−</span>
              <span class="s1-frac">3/8</span>
              <span class="s1-op">=</span>
              <span class="s1-slate">
            ...
            <div class="lbar-cap">write the top number on the Slate, then Check</div>
  ...
  tutorHTML: `
          <div class="ltutor">
            ...
            <div class="ribbon">Just the numbers: 7/8 − 3/8 = ? Subtract the tops, keep the bottom, write the answer.</div>
          </div>`,
};
