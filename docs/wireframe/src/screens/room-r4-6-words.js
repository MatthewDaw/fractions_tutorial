/* room-r4-6-words — №9 Simplify · Words · Stage 6 (AppR4, 6/r4).
...
export default {
  ...
  railHTML: `
          <div class="panel">
            ...
            <div class="hint">Babushka cut her sourdough loaf into <b>twelve</b> even slices for the week. By Friday the family had eaten four of them, so <b>eight</b> slices are left. What fraction of the whole loaf is left — written as its simplest name?</div>
          </div>`,

  stageHTML: `
          <div class="r4-s-story">
            <!-- the word→math surface: OPTIONAL ungraded scratch (Words) -->
            <div class="r4-s-setup">
              <span class="r4-s-setup-lead">Optional — show your work here</span>
              <div class="bs-surface r4-s-scratch-surface" style="position:relative;">
  ...
  answerHTML: `
          <div class="lbar r4-s-answer-words">
            <div class="r4-s-ansprompt">Write the same amount as its simplest name</div>
            <div class="r4-s-answrite">
              <!-- Slate, layout="fraction", den=3 — STYLUS write cells (uncommitted) -->
              <div class="slate slate-fraction" role="group" aria-label="write the simplest fraction">
  ...
  tutorHTML: `
          <div class="ltutor">
            ...
            <div class="ribbon">Read the recipe. The leftover comes out unwieldy — write the same amount as its simplest name.</div>
          </div>`,
};
