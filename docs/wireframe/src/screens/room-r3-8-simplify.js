/* room-r3-8-simplify — №10 Scale One · Stage "Simplify" (LessonUnlikeDen, #/r3).
   ...
   The capstone that ties the strand together: after adding 1/6 + 1/3 = 3/6,
   you must SIMPLIFY the answer. Both 3 and 6 divide by 3, so bundle ÷3 to
   reach 1/2. A sum isn't done until it's in lowest terms. */
export default {
  kind: "lesson",
  lesson: "r3",
  ...
  goalHTML: `You added and got <b>3/6</b> — but a fraction isn't finished until it's in <b>lowest terms</b>. <b>3</b> and <b>6</b> both divide by <b>3</b>, so bundle <b>÷3</b> to reach <b>1/2</b>. <b>Always simplify your answer.</b>`,

  stageHTML: `
    <div class="eq-stage" style="flex-direction:column; gap:22px; align-items:center; justify-content:center; height:100%">
      <div class="eq-stage" style="padding:0; gap:20px; align-items:center">
        <div class="bignum" style="font-size:48px"><span class="n" style="color:var(--red)">1</span><span class="bar" style="background:var(--ink)"></span><span class="d">6</span></div>
        <span class="eq-eq" style="font-style:normal">+</span>
        <div class="bignum" style="font-size:48px"><span class="n" style="color:var(--red)">1</span><span class="bar" style="background:var(--ink)"></span><span class="d">3</span></div>
        <span class="eq-eq" style="font-style:normal">=</span>
        <div class="bignum" style="font-size:48px"><span class="n" style="color:var(--red)">3</span><span class="bar" style="background:var(--ink)"></span><span class="d">6</span></div>
      </div>
      <div class="eq-eq">÷3 ↓</div>
      <div class="bignum" style="font-size:64px"><span class="n" style="color:var(--red)">1</span><span class="bar" style="background:var(--ink)"></span><span class="d">2</span></div>
      <div class="eq-cap">3 and 6 share the factor <b>3</b> — divide both to reach <b>1/2</b></div>
    </div>`,
  ...
  railHTML: `
    <div class="panel">
      ...
      <div class="hint">
        You added and got <b>3/6</b> — but a fraction isn't finished until it's in
        <b>lowest terms</b>. <b>3</b> and <b>6</b> both divide by <b>3</b>, so bundle
        <b>÷3</b> to reach <b>1/2</b>. <b>Always simplify your answer.</b>
      </div>
    </div>`,
  ...
  answerHTML: `
    <div class="lbar">
      <div class="lbar-eq">
        <span class="bignum"><span class="n" style="color:var(--red)">3</span><span class="bar" style="background:var(--ink)"></span><span class="d">6</span></span>
        <span class="nl-ans-eq">=</span>
        <span class="nl-ans-amt">simplest answer:</span>
        <span class="den-choices"><span class="den-choice is-on">1/2</span><span class="den-choice">3/6</span><span class="den-choice">2/6</span></span>
      </div>
      <div class="lbar-cap">add, then reduce to lowest terms — 3/6 = 1/2</div>
  ...
  tutorHTML: `
    <div class="ltutor">
      ...
      <div class="ribbon">You're not done at 3/6. Three and six both divide by three — simplify to 1/2. Always reduce your answer to lowest terms.</div>
    </div>`,
};
