/* room-r3-2-bind — №10 Scale One · Bind · Stage 2 (LessonUnlikeDen, #/r3).
...
export default {
  ...
  stageHTML: `
          <div class="canvas lu-canvas" id="r2canvas">
            ...
            <!-- the joined strip: BigFrac tag (count hidden) over Combined plank -->
            <div class="nbar" style="left:60px; top:156px;">
              <div class="btag">
                <div class="bignum"><span class="n">?</span><span class="bar" style="background:#d1495b;"></span><span class="d">8</span></div>
              </div>
              <!-- Combined: 5 eighths, heavier divider at the a|b seam (after 3rd) -->
              <div class="plank lit" style="width:375px;">
                <div class="plank-body">
                  <div class="piece" style="width:75px; background:#d1495b; border-right:1.5px solid rgba(237,226,200,0.55);"><span class="piece-lab" style="color:#ede2c8; font-size:15px;">1/8</span></div>
                  <div class="piece" style="width:75px; background:#d1495b; border-right:1.5px solid rgba(237,226,200,0.55);"><span class="piece-lab" style="color:#ede2c8; font-size:15px;">1/8</span></div>
                  <div class="piece" style="width:75px; background:#d1495b; border-right:3px solid rgba(237,226,200,0.8);"><span class="piece-lab" style="color:#ede2c8; font-size:15px;">1/8</span></div>
                  <div class="piece" style="width:75px; background:#d1495b; border-right:1.5px solid rgba(237,226,200,0.55);"><span class="piece-lab" style="color:#ede2c8; font-size:15px;">1/8</span></div>
  ...
  railHTML: `
          <div class="panel">
            <h3 class="pick-title">Match the Sizes</h3>
            <div class="hint">One strip already fits the other — pick the size both can be (you only have to rename one).</div>

            <div class="worksheet">
              <div class="ws-row">
                <span class="ws-frac">3/8</span>
                <span class="ws-arrow">→</span>
                <span class="ws-frac scaled on">3/8</span>
              </div>
              <div class="ws-plus">+</div>
              <div class="ws-row">
                <span class="ws-frac">1/4</span>
                <span class="ws-arrow">→</span>
                <span class="ws-frac scaled on">2/8</span>
              </div>
            </div>
            ...
            <div class="denpicker is-locked">
              ...
              <div class="picker-grid" role="group" aria-label="common denominator">
                <button type="button" class="picker-choice sel" aria-pressed="true" disabled><span class="pc-num">8</span></button>
                <button type="button" class="picker-choice" disabled><span class="pc-num">16</span></button>
                <button type="button" class="picker-choice" disabled><span class="pc-num">24</span></button>
              </div>
              <div class="picker-readouts">
                <div class="pread on">The <b>3/8</b> strip: multiply by <span class="pxn">×1</span></div>
                <div class="pread on">The <b>1/4</b> strip: multiply by <span class="pxn">×2</span></div>
              </div>
  ...
  tutorHTML: `
          <div class="ltutor">
            ...
            <div class="ribbon">Joined! Write the bottom number first — how big is each block? — then press Check.</div>
          </div>`,
};
