/* room-num-6-story — №4 The Top Number · Stage 6 "Story" (word problem with the
   numbers IN it). The digits are given in the text; the child turns the words
   into a fraction and writes it. Snapshot: 8 slices, 5 filled → write 5/8. */
  ...
  stageHTML: `
    <div class="den-play">
      <div class="den-ruler-wrap">
        <div class="den-ruler">${ruler(8, 0)}</div>
        <div class="den-ends"><span>0</span><span>1</span></div>
        <div class="den-cap">The tray has 8 equal slices — shade the ones Babushka filled to picture it.</div>
      </div>
    </div>`,
