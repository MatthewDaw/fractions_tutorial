/* room-m3-3-fade — №2 Times Facts · Fade · Stage 3 (AppM3, #/m3).
...
export default {
              ...
              <div class="m3-fade">
                ...
                <div class="m3-skipline">
                  <div class="m3-skipline-track" aria-label="skip-count number line">
                    <div class="m3-skipline-rail" aria-hidden="true"></div>
                    <div class="m3-skipline-stop"><span class="m3-skipline-tick" aria-hidden="true"></span><span class="m3-skipline-term is-given" aria-label="8">8</span></div>
                    <div class="m3-skipline-stop"><span class="m3-skipline-tick" aria-hidden="true"></span><span class="m3-skipline-term is-given" aria-label="16">16</span></div>
                    <div class="m3-skipline-stop"><span class="m3-skipline-tick" aria-hidden="true"></span><span class="m3-skipline-term is-blank is-slot is-active" aria-label="drop the missing number here">?</span></div>
                    <div class="m3-skipline-stop"><span class="m3-skipline-tick" aria-hidden="true"></span><span class="m3-skipline-term is-given" aria-label="32">32</span></div>
                    <div class="m3-skipline-stop"><span class="m3-skipline-tick" aria-hidden="true"></span><span class="m3-skipline-term is-blank is-slot" aria-label="drop the missing number here">?</span></div>
                    <div class="m3-skipline-stop"><span class="m3-skipline-tick" aria-hidden="true"></span><span class="m3-skipline-term is-given" aria-label="48">48</span></div>
                    <div class="m3-skipline-stop"><span class="m3-skipline-tick" aria-hidden="true"></span><span class="m3-skipline-term is-given" aria-label="56">56</span></div>
                  </div>

                  <div class="m3-skipline-chips" role="group" aria-label="drag the missing number onto the line">
                    <span class="m3-skipline-chips-lead">drag the missing number onto the line</span>
                    <button type="button" class="m3-skipline-chip" aria-label="number 24 — drag onto the line">24</button>
                    <button type="button" class="m3-skipline-chip" aria-label="number 31 — drag onto the line">31</button>
                    <button type="button" class="m3-skipline-chip" aria-label="number 40 — drag onto the line">40</button>
                    <button type="button" class="m3-skipline-chip" aria-label="number 47 — drag onto the line">47</button>
                  </div>
                </div>
              </div>
            </div>
  ...
  railHTML: `
          <div class="panel">
            <h3>Fill the Line</h3>
            <div class="hint">The jar just confirms it now — let the number line lead. Two hops are missing; count on by 8 to fill them, then write the product.</div>
            <div class="m3-factcard">
              <span class="m3-factcard-eq">7 × 8 = ?</span>
              <div class="m3-factcard-note">hops of 8</div>
            </div>
          </div>`,
  ...
  answerHTML: `
          <div class="lbar">
            ...
            <div class="lbar-cap">fill the missing hops first</div>
  ...
  tutorHTML: `
          <div class="ltutor">
            ...
            <div class="ribbon">The jar just confirms it now — fill the missing hops on the line, then write 7 × 8.</div>
          </div>`,
};
