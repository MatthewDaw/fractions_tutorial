...
export default {
  ...
  railHTML: `
          <div class="panel">
            <h3 class="pick-title">Cut Both</h3>
            <div class="hint">Neither bottom fits the other — pick the size both reach (you rename both).</div>
            <div class="worksheet">
              <div class="ws-row">
