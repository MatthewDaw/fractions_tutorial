/* room-r3-sw-showwork — №6 Scale One · Show Work. Word-problem/show-work page
   folded onto the shared <LessonScreen> 4-zone grid (spec Step 3). The mandatory
   BlankSlate is the single interactive surface → stage, the Next gate → answer,
   the instruction → rail, Cook → tutor. The duplicate goal banner is removed.
...
export default {
  ...
  stageHTML: `
          <div class="play lu-showwork-play">
  ...
  railHTML: `
          <div class="panel">
            ...
            <div class="hint">Show your work. Write out — any way you like — how you'd add <b>3/8 + 1/4</b>, then press Next.</div>
          </div>`,

  answerHTML: `
          <div class="marks">
            <button type="button" class="check" disabled>Next ▸</button>
          </div>`,
  ...
  tutorHTML: `
          <div class="ltutor">
            ...
            <div class="ribbon">Show your work, povaryonok — write out how you'd solve it on the blank slate, then press Next.</div>
          </div>`,
};
