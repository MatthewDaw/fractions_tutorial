/* room-r2-6-numbers — №11 Cross-Multiply · Numbers (bare cross-multiply, beat L6 · #/r2).
...
export default {
  ...
  stageHTML: `
          <div class="canvas lu-canvas" id="r2canvas">
            ...
            <div class="lu-cross">
              <div class="lu-cross-eq">
                <span class="lu-cf">1/2</span>
                <span class="qop">+</span>
                <span class="lu-cf">1/3</span>
                <span class="qop">=</span>
                <span class="slate-blank">?</span>
              </div>
              <!-- the crossing arrows: each bottom arcs to the OTHER fraction,
                   carrying the ×N it contributes (the classic cross-multiply X) -->
              <svg class="lu-cross-svg" viewBox="0 0 220 120" aria-hidden="true" preserveAspectRatio="xMidYMid meet">
                <defs>
                ...
                <path d="M40 26 C 130 40, 130 80, 40 94" fill="none" stroke="var(--red)" stroke-width="2.4" stroke-dasharray="5 5" marker-end="url(#luArrow)" />
                <path d="M40 94 C 130 80, 130 40, 40 26" fill="none" stroke="var(--red)" stroke-width="2.4" stroke-dasharray="5 5" marker-end="url(#luArrow)" />
                <text x="150" y="40" class="lu-cross-x">×3</text>
                <text x="150" y="92" class="lu-cross-x">×2</text>
              </svg>
              <div class="lu-cross-rule">
                1/2 <b>×3/3</b> → 3/6
                <span class="lu-cross-plus">+</span>
                1/3 <b>×2/2</b> → 2/6
                <span class="lu-cross-note">Rename BOTH to equivalent fractions over the same bottom 6, then add like same-denominators: 3/6 + 2/6.</span>
                <span class="lu-cross-note lu-cross-shortcut"><b>Fast way:</b> the common bottom is just 2 × 3 = 6 — a shortcut, not the reason it works.</span>
              </div>
            </div>
  ...
  railHTML: `
          <div class="panel">
            <h3>On the Slate</h3>
            <div class="hint">
              Nothing but the numbers. Rename BOTH fractions as equivalent fractions
              over a common bottom, then add like same-denominators. Fast way: the
              common bottom is the two bottoms multiplied.
            </div>
          ...
          <div class="lbar lu-ansbar">
            <div class="lbar-eq">
              ...
              <span class="lu-ans-slot">
                <span class="lu-slate">
                  <!-- the handwriting Slate (fraction layout): numerator over a
                       denominator-colored bar over the denominator. Stage "den":
                       the numerator is locked, the denominator pulses to write. -->
  ...
  tutorHTML: `
          <div class="ltutor">
            ...
            <div class="ribbon">Bare slate. Find the common denominator, scale, and add — write it all.</div>
          </div>`,
};
