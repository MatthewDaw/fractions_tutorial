/* room-r3-6-numbers — №10 Scale One · Numbers (LessonUnlikeDen, #/r3).
...
export default {
  ...
  stageHTML: `
          <!-- noBars beat: just the bare equation (no manipulatives, Scale One = no crossing) -->
          <div class="canvas lu-canvas" id="r2canvas">
            <div class="slate-eq">
              <span>3/8 + 1/4</span><span class="qop">=</span><span class="slate-blank">?</span>
            </div>
          </div>`,
  ...
  railHTML: `
          <div class="panel">
            <h3>On the Slate</h3>
            <div class="hint">Nothing but the numbers. Rename just the one that doesn't fit into an equivalent fraction over the common bottom, then add like same-denominators.</div>
            <div class="bare-eq">3/8 + 1/4 = <b>?</b></div>
          </div>`,
          ...
          <div class="lbar lu-ansbar">
            <div class="lbar-eq">
              ...
              <span class="lu-ans-slot">
                <span class="lu-slate">
                  <!-- answer Slate: two-stage gate at "den" — numerator locked, denominator open -->
                  <div class="slate slate-fraction is-disabled" role="group" aria-label="write the total fraction">
                    <div class="slate-slot is-disabled">
                      <div class="slate-cell"><span class="slate-ph" aria-hidden="true"></span></div>
                    </div>
