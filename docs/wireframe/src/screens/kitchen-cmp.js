/* kitchen-cmp — Babushka's Kitchen question for №11 Compare & Check.
...
export default {
  ...
  recipe: `This recipe uses <b>Lesson 11 · Compare &amp; Check</b> — rename both to the same bottom, then more on top wins.`,
