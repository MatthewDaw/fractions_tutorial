/* room-r5-sw-showwork — №9 Mixed Numbers · Show Work (lesson r5, #/r5).
   ...
   lives here. Word-problem/show-work layout folded onto the 4 zones
   (spec Step 3): instruction → rail, blank-slate work surface → stage, the
   Next gate → answer, Cook + ribbon → tutor. Interactive markup is verbatim. */
export default {
  kind: "lesson",
  ...
  stageHTML: `
          <!-- BlankSlate mounts on an 800×360 bs-surface — free-form, ungraded -->
  ...
  railHTML: `
          <div class="panel">
            ...
            <div class="hint">Babushka can't ask for <b>9/7</b> of a tray — that's more than one whole. Use the slate to work it out however you like — group the pieces, write the division, sketch it. Put something down, then tap Next.</div>
          </div>`,
  ...
  tutorHTML: `
          <div class="ltutor">
            ...
            <div class="ribbon">Show your work — write anything you like on the blank slate, then tap Next.</div>
          </div>`,
};
