/* room-r4-sw-showwork — №9 Simplify · Show Work · Stage SW (AppR4, SW/r4).
...
export default {
  ...
  railHTML: `
          <div class="panel">
            ...
            <div class="hint">Show how you'd simplify <b>8/12</b> — write anything you like on the slate. When you've put something down, tap Next.</div>
          </div>`,

  stageHTML: `
          <div class="fit-stage r4-s-fit r4-s-fit-showwork">
            <div class="fit-stage-content">
              <div class="r4-s-setup">
                <span class="r4-s-setup-lead">Show your work here</span>
                <!-- BlankSlate inside a framed bs-surface (1120×330) -->
                <div class="bs-surface" style="position:relative;width:1120px;height:330px;">
  ...
  answerHTML: `
          <div class="lbar r4-s-answer-words">
            <div class="r4-s-ansprompt">When you've shown your work, move on</div>
  ...
  tutorHTML: `
          <div class="ltutor">
            ...
            <div class="ribbon">Show your work on the blank slate — write anything you like. When you've put something down, you can move on.</div>
          </div>`,
};
