...
export default {
  ...
  railHTML: `
          <div class="panel">
            ...
            <div class="hint">Babushka needs <b>2/7</b> + <b>3/7</b> of a tray — how much in all?</div>
          </div>`,
  ...
  tutorHTML: `
          <div class="ltutor">
            ...
            <div class="ribbon">A question in words, with the fractions shown. Write it as a sum first (2/7 + 3/7), then give the answer.</div>
          </div>`,
};
