/* room-s1-4-words — №4 Taking Away · Words (AppSubtract, #/s1 stage 4).
...
export default {
  ...
  stageHTML: `
          <div class="wp-setup">
                  ...
                  <div class="wp-setup-row">
                    <div class="bs-surface s1-words-scratch">
  ...
  answerHTML: `
          <div class="lbar">
            <div class="lbar-eq">
              <div class="slate slate-fraction" role="group" aria-label="write the total">
            ...
            <div class="lbar-cap">write how much is left, then Check</div>
  ...
  tutorHTML: `
          <div class="ltutor">
            ...
            <div class="ribbon">A story this time — read it, find the two fractions, and write how much is left.</div>
          </div>`,
};
