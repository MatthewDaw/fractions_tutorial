...
export const DENOMINATOR_COLORS = {
  2:  { hue: "#1f6fd6", pattern: "diagonal",    name: "halves"   },
  3:  { hue: "#e07b00", pattern: "diagonal",    name: "thirds"   },
  4:  { hue: "#0a9396", pattern: "cross_hatch", name: "fourths"  },
  ...
  8:  { hue: "#d1495b", pattern: "diagonal",    name: "eighths"  },
  9:  { hue: "#2a9d8f", pattern: "ring",        name: "ninths"   },
  10: { hue: "#7b2cbf", pattern: "dense_dots",  name: "tenths"   },
  12: { hue: "#386641", pattern: "cross_hatch", name: "twelfths" },
};
