// Cook.jsx — the tutor: a vintage two-tone woodcut of a friendly cook.
...
// eyes/mouth and a small prop.   expr: 'idle' | 'think' | 'cheer'
export default function Cook({ expr = "idle", width = 196 }) {
  const ink = "var(--ink)";
  ...
  return (
    <svg width={width} height={width * (260 / 196)} viewBox="0 0 196 260"
      ...
      <g stroke={ink} strokeWidth="2.4" strokeLinejoin="round" strokeLinecap="round">
        <path d="M44 258 Q40 188 58 168 Q72 154 98 154 Q124 154 138 168 Q156 188 152 258 Z" fill={paper} />
      ...
      <g transform={expr === "cheer" ? "rotate(-26 168 218)" : "rotate(6 168 218)"}
        ...
        <ellipse cx="188" cy="170" rx="8" ry="11" fill={paper2} stroke={ink} strokeWidth="2.2" transform="rotate(18 188 170)" />
      </g>
      ...
      <g stroke={ink} strokeWidth="2.6" strokeLinejoin="round">
        ...
        <path d="M64 56 Q50 52 52 36 Q40 30 50 18 Q58 6 76 12 Q86 0 104 8 Q124 2 130 18 Q150 22 144 38 Q152 52 132 56 Q132 40 120 44 Q120 30 104 34 Q104 22 88 28 Q84 40 72 38 Q74 52 64 56 Z" fill={paper} />
      </g>
