...
export default {
  ...
  tabs: [
    ...
    { n: "2", name: "Match",   sub: "match the ruler to its number",     href: "room-den-match.html" },
    { n: "3", name: "Build",   sub: "make two squares match (bottom only)", href: "room-den-build.html" },
    { n: "4", name: "Numbers", sub: "smaller — just from the number",    href: "room-den-4-numbers.html" },
