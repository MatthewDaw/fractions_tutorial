...
export default {
  ...
  route: "#/simp",
  tabs: [
    { n: "1", name: "Identify",     sub: "name the chunky fraction — 8/12",                    title: "name the chunky fraction — 8/12" },
    { n: "2", name: "Bundle",       sub: "merge every 2 cells — 8/12 = 4/6, same amount",       title: "merge every 2 cells — 8/12 = 4/6, same amount" },
    { n: "3", name: "Lowest Terms", sub: "bundle until no group fits — that's simplest",         title: "bundle until no group fits — that's simplest" },
    { n: "4", name: "Big Bundle",   sub: "÷ the biggest factor — reach simplest in one move",   title: "÷ the biggest factor — reach simplest in one move" },
    { n: "5", name: "Pick",         sub: "choose the simplest top & bottom",                     title: "choose the simplest top & bottom" },
    { n: "6", name: "Numbers",      sub: "no picture — write the simplest name",                 title: "no picture — write the simplest name" },
    { n: "★", name: "Practice",     sub: "Fresh problems — paced to your mastery",               title: "Fresh problems — paced to your mastery" },
  ],
  ...
  goals: {
    ...
    pick:        "The target is *8/12*. Pick the top and bottom that keep the same red amount but use the *fewest pieces*. 4/6 matches too — but *2/3* is as low as it goes. Choose the simplest pair.",
    numbers:     "No picture — just the numbers. Divide the top and bottom by their *greatest common factor*, then write the equivalent fraction in *lowest terms* on the Slate.",
  },
};
