...
export default {
  ...
  tabs: [
    ...
    { n: "4", name: "Whole",   sub: "make it whole — top equals bottom",       href: "room-num-3-whole.html" },
    { n: "5", name: "Build",   sub: "match two squares (both numbers)",  href: "room-num-build.html" },
    { n: "6", name: "Numbers", sub: "reason from bare symbols",    href: "room-num-5-numbers.html" },
    { n: "7", name: "Story",   sub: "a problem with the numbers in it",  href: "room-num-6-story.html" },
    { n: "8", name: "Words",   sub: "a story problem",                   href: "room-num-7-words.html" },
