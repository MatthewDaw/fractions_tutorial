...
export default {
  ...
  route: "#/num",
  tabs: [
    { n: "1", name: "Shade",   sub: "try different top numbers",         href: "room-num.html" },
    { n: "2", name: "Count",   sub: "the top number counts the shaded",  href: "room-num-2-count.html" },
    { n: "3", name: "Whole",   sub: "fill every piece — n/n is 1",       href: "room-num-3-whole.html" },
    { n: "4", name: "Build",   sub: "match two squares (top only)",      href: "room-num-build.html" },
    { n: "5", name: "Make",    sub: "match two squares (both numbers)",  href: "room-num-make.html" },
    { n: "6", name: "Numbers", sub: "more on top — just the symbols",    href: "room-num-5-numbers.html" },
    { n: "7", name: "Paint",   sub: "paint K/N of the square red",       href: "room-num-paint.html" },
