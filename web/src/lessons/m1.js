...
export default {
  ...
  tabs: [
    ...
    { n: "3", name: "Workbench", sub: "build it in bowls", href: "room-m1-4-workbench.html", title: "build it in bowls" },
    { n: "4", name: "Numbers", sub: "bare 3 × 4 = ?", href: "room-m1-5-numbers.html", title: "bare 3 × 4 = ?" },
    { n: "5", name: "Applied", sub: "write the setup, then total", href: "room-m1-6-applied.html", title: "write the setup, then total" },
    { n: "6", name: "Show Work", sub: "show your work", href: "room-m1-sw-showwork.html", title: "show your work" },
