...
export const ROOMS = [
  ...
  { id: "r4", nodeId: "SIMPLIFY",           no: 7, title: "Simplify",          concept: "Reduce to the fewest, biggest pieces — lowest terms.",                    built: true,  pos: { x: 180, y: 650 }, intro: "/intros/r4-simplify.html", introDurationMs: 28000, verb: "Simplifying", example: "8/12 → 2/3" },
