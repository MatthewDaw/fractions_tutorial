...
export const ROOMS = [
  ...
  { id: "nl", nodeId: "FRACTION_ON_LINE",   no: 4,  title: "On the Number Line", concept: "A fraction is a NUMBER — one point on the line, found by cutting 0 to 1 into equal parts.", built: true, pos: { x: 1100, y: 80 },  verb: "Placing",     example: "3/4 on 0→1" },
  ...
  { id: "s1", nodeId: "SUB_SAME_DEN",       no: 6,  title: "Taking Away",       concept: "Same-size pieces — break the stack, take some off, keep the bottom.",     built: true,  pos: { x: 1100, y: 760 }, verb: "Subtracting", example: "5/8 − 2/8" },
  { id: "cmp", nodeId: "COMPARE_BENCHMARK", no: 7,  title: "Compare & Check",   concept: "See which fraction is bigger, and reason about a sum's size from benchmarks.", built: true, pos: { x: 640, y: 760 },  verb: "Comparing",   example: "3/8 < 5/8" },
